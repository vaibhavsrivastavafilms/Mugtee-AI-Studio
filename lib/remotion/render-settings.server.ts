...
/** libx264 thread cap ΓÇö prevents x264 auto-spawn (e.g. 24 threads) OOM on dev boxes. */
...
/** Mock stub duration ΓÇö matches content length; never force a 15s full-res encode. */
...
/** Half-res mock encode unless MOCK_RENDER_FULL_RES=true ΓÇö halves x264 frame buffers. */
