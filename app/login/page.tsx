    ...
    return (
      <div className="min-h-screen w-full flex items-center justify-center bg-background px-6">
        <div className="w-full max-w-md space-y-4">
          <div className="h-12 w-12 rounded-2xl bg-[#D4AF37]/20 mx-auto shimmer-cinematic" />
          <div className="h-4 w-32 mx-auto rounded bg-white/[0.04] shimmer-cinematic" />
          ...
          <div className="glass-strong rounded-3xl p-7 sm:p-10 relative">
            <div className="text-center mb-7">
              ...
              <h2 className="font-display text-2xl sm:text-3xl mb-1.5">
                Enter the{' '}
                <span className="text-gold-gradient">cinematic studio</span>
              </h2>
              <p className="text-xs sm:text-sm text-muted-foreground">
                Sign in to continue directing your cinematic worlds.
              </p>
            </div>
