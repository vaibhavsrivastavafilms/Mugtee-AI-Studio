...
type LibraryIdea = { id: string; title: string; hook?: string; angle?: string; niche?: string; platform?: string; created_at: string }
type LibraryPrompt = { id: string; script_title?: string; prompts: { type: string; prompt: string }[]; created_at: string }
