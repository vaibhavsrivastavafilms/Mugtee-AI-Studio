...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  return [
    ...
    { url: `${SITE_URL}/blog/best-faceless-youtube-niches`,   lastModified: now, changeFrequency: 'monthly', priority: 0.6 },
    { url: `${SITE_URL}/blog/ai-documentary-script-workflow`, lastModified: now, changeFrequency: 'monthly', priority: 0.6 },
    { url: `${SITE_URL}/blog/how-to-make-viral-reels-faster`, lastModified: now, changeFrequency: 'monthly', priority: 0.6 },
