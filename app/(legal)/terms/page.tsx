...
export const metadata: Metadata = {
  ...
  description: 'Terms governing your use of Mugtee — acceptable use, AI content, intellectual property, billing, and termination.',
}
    ...
    <>
      <div className="mb-9">
        ...
        <p className="text-sm text-muted-foreground leading-relaxed max-w-xl">
          The boring-but-important bit. By using Mugtee you agree to these terms. We've tried to keep them short and human.
        </p>
      </div>

      <Section icon={UserCheck} title="Acceptance & eligibility">
        <p>By creating an account or using Mugtee (“the Service”), you agree to these Terms and our <Link href="/privacy" className="text-gold-300 hover:underline">Privacy Policy</Link>. You must be at least 13 years old and capable of forming a binding contract in your jurisdiction.</p>
      </Section>

      <Section icon={ScrollText} title="Your content & our content">
        <p><strong className="text-luxe">You own what you create.</strong> Scripts, ideas, captions, media, and other content you produce in Mugtee remain yours. You grant us a limited license to store, display, and process your content solely to operate the Service.</p>
        <p><strong className="text-luxe">We own the platform.</strong> The Mugtee software, design, UI, brand, and underlying models are protected by copyright, trademark, and other laws. You may not copy, resell, or reverse-engineer the Service.</p>
      </Section>

      <Section icon={AlertTriangle} title="AI output — know what you're shipping">
        <p>Mugtee generates content using third-party large language models. <strong className="text-luxe">Output is suggestions, not facts.</strong> You are responsible for reviewing, fact-checking, and editing any AI output before publishing.</p>
      ...
      <Section icon={Ban} title="Acceptable use">
        <p>Don't use Mugtee to generate, schedule, or publish content that is illegal, infringing, deceptive, sexually explicit involving minors, harassing, or designed to spread disinformation or manipulate elections. We reserve the right to suspend accounts that violate these rules or the policies of connected platforms.</p>
      </Section>
      ...
      <Section icon={Scale} title="Disclaimers & limitation of liability">
        <p>The Service is provided “as is” without warranties of any kind. To the maximum extent permitted by law, Mugtee and its operators are not liable for indirect, incidental, or consequential damages arising from use of the Service, including lost revenue, lost followers, or platform penalties from content you chose to publish.</p>
