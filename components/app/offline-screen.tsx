...
/** Full-screen offline shell — only when navigator reports no connectivity. */
  ...
  return (
    <main className="min-h-screen flex flex-col items-center justify-center px-6 text-center bg-[#0B0B0B] text-[#E8D9A8]">
      ...
      <p className="text-sm text-[#E8D9A8]/70 max-w-sm">
        Mugtee AI Studio needs an internet connection to shape, save, and continue your cinematic
        work. Reconnect and we’ll pick up exactly where you left off.
      </p>
      <button
        type="button"
