...
export function StyleLibraryDrawer({
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent
        className="fixed inset-y-0 right-0 left-auto top-0 h-[100dvh] max-h-[100dvh] w-full sm:max-w-[420px] translate-x-0 translate-y-0 rounded-none border-l border-white/[0.08] bg-[#070707]/98 backdrop-blur-2xl p-0 flex flex-col gap-0 data-[state=open]:slide-in-from-right"
      >
        <DialogHeader className="px-5 pt-5 pb-3 border-b border-white/[0.06] text-left shrink-0 space-y-1">
          <DialogTitle className="font-display text-base text-violet-200 tracking-wide">
            Creative Systems
          </DialogTitle>
          <DialogDescription className="text-[11px] text-luxe/50 leading-relaxed">
            Browse systems, filter by category, and apply continuity locks to your film.
          </DialogDescription>
        </DialogHeader>
