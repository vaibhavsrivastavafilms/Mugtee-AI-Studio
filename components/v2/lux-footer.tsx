...
const COMPANY_LINKS = [
  ...
  { label: 'Contact', href: 'mailto:hello@mugtee.in' },
] as const
      ...
      <div className="mx-auto max-w-6xl space-y-12">
          ...
          <div className="sm:col-span-2 lg:col-span-1">
            ...
            <form onSubmit={subscribe} className="flex gap-2">
              ...
              <button
                ...
                className="shrink-0 flex h-10 w-10 items-center justify-center rounded-lg bg-[var(--v2-gold)] text-black hover:opacity-90 disabled:opacity-50"
              >
        ...
        <div className="flex flex-col sm:flex-row items-center justify-between gap-4 pt-8 border-t border-[var(--v2-border)]">
          ...
          <div className="flex items-center gap-6">
            <Link
              href="/privacy"
              className="text-[11px] tracking-wider uppercase text-[var(--v2-text-secondary)] hover:text-[var(--v2-gold)] transition-colors"
            >
              Privacy
            </Link>
            <Link
