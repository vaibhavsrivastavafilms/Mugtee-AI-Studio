...
const SLIDES: Slide[] = [
  ...
  },
  {
    ...
    sub: 'Virlo helps creators stay consistent, automate workflows and scale faceless channels.',
    ...
    cta: { label: 'Launch Virlo Studio', href: '/dashboard' },
    icon: TrendingUp,
  },
]
            ...
            <div className="px-5 sm:px-8 py-4 border-t border-white/[0.06] bg-black/40 backdrop-blur flex items-center justify-between gap-3 flex-wrap shrink-0">
              ...
              <div className="flex items-center gap-2 ml-auto">
                ...
                {isLast ? (
                  ...
                  >
                    <Sparkles className="w-4 h-4" /> Launch Virlo Studio
                  </Link>
                ) : (
                  <button
                    onClick={next}
