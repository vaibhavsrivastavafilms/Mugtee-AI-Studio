...
export function StatCards() {
  ...
  const computed: Stat[] = [
    { key: 'total',        label: 'Total Content Pieces', value: String(content.length),  delta: '+12%', icon: Film,       accent: 'from-gold-500/20 to-gold-700/0' },
    { key: 'scheduled',    label: 'Scheduled Posts',      value: String(scheduled),       delta: '+4',   icon: Calendar,   accent: 'from-amber-400/20 to-amber-700/0' },
    { key: 'inproduction', label: 'In Production',        value: String(inProduction),    delta: '+2',   icon: TrendingUp, accent: 'from-rose-400/15 to-rose-700/0' },
    { key: 'crew',         label: 'Active Crew',          value: String(crew.length),     delta: 'live',icon: Users,      accent: 'from-emerald-400/15 to-emerald-700/0' },
  ]
